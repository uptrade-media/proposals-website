...
{/* Hero Section */}
<section className="relative overflow-hidden bg-black py-16 min-h-screen flex items-center">
  ...
  <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
    <div className="text-center">
      {/* Row 94 Style Badge */}
      <div className="inline-flex items-center bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-6 py-3 text-sm font-bold tracking-wider mb-8 transform -skew-x-12 shadow-lg">
      ...
      <div className="max-w-3xl mx-auto mb-12">
        <p className="text-2xl text-white leading-relaxed font-medium drop-shadow-lg">
      ...
      <div className="relative inline-block">
        <div className="absolute -inset-4 border-2 border-yellow-500 transform rotate-1 shadow-xl"></div>
        <div className="relative bg-black bg-opacity-80 border border-yellow-400 p-8 backdrop-blur-sm">
          <div className="flex flex-col md:flex-row justify-center items-center space-y-3 md:space-y-0 md:space-x-12 text-white">
            <div className="flex items-center">
              ...
              <span className="font-bold text-lg tracking-wide">ROW 94 WHISKEY TEAM</span>
            </div>
            <div className="flex items-center">
              <Calendar className="h-6 w-6 mr-3 text-yellow-400" />
              <span className="font-bold text-lg tracking-wide">OCTOBER 10, 2025</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl shadow-lg border p-8 mb-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <a href={SemrushPDF} download>
                <Button variant="outline" size="sm" className="border-yellow-600 text-yellow-600 hover:bg-yellow-600 hover:text-black font-bold">
          ...
          {/* Critical Issues */}
          <div className="bg-black rounded-xl p-8 border-l-4 border-yellow-500">
            <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
              <AlertTriangle className="h-6 w-6 mr-3 text-yellow-400" />
              <span className="text-yellow-400">CRITICAL DIGITAL GAPS</span> IDENTIFIED
            </h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-300 rounded-lg p-6 shadow-lg">
                <h4 className="font-bold text-black mb-3 flex items-center text-lg">
                ...
                <div className="text-3xl font-black text-yellow-600">22.44%</div>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-300 rounded-lg p-6 shadow-lg">
                ...
                <div className="text-3xl font-black text-yellow-600">HIGH RISK</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl shadow-lg border p-8 mb-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">How Row 94 Compares to Leading Whiskey Brands</h3>
            
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    <th className="text-left py-4 px-4 font-semibold text-gray-900">Brand</th>
                    <th className="text-center py-4 px-4 font-semibold text-gray-900">Monthly Organic Traffic</th>
                    <th className="text-center py-4 px-4 font-semibold text-gray-900">Keywords Ranking</th>
                    <th className="text-center py-4 px-4 font-semibold text-gray-900">Authority Score</th>
                    <th className="text-center py-4 px-4 font-semibold text-gray-900">Market Position</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-4">
                      <div className="font-medium text-gray-900">Row 94 Whiskey</div>
                    ...
                    <td className="text-center py-4 px-4">
                      ...
                      <div className="text-xs text-orange-500">Needs improvement</div>
                    </td>
                    <td className="text-center py-4 px-4">
                  ...
                  <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-4">
                      <div className="font-medium text-gray-900">Calumet Bourbon</div>
                    ...
                    <td className="text-center py-4 px-4">
                      ...
                      <div className="text-xs text-green-500">Strong authority</div>
                    </td>
                    <td className="text-center py-4 px-4">
                  ...
                  <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-4">
                      <div className="font-medium text-gray-900">Augusta Distillery</div>
                      <div className="text-sm text-gray-500">Regional Competitor</div>
                    </td>
                    <td className="text-center py-4 px-4">
                    ...
                    <td className="text-center py-4 px-4">
                      ...
                      <div className="text-xs text-yellow-500">Solid foundation</div>
                    </td>
                    <td className="text-center py-4 px-4">
                  ...
                  <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-4">
                      <div className="font-medium text-gray-900">Brother Justus</div>
                      <div className="text-sm text-gray-500">UX Issues Present</div>
                    </td>
                    <td className="text-center py-4 px-4">
                    ...
                    <td className="text-center py-4 px-4">
                      ...
                      <div className="text-xs text-yellow-500">Good authority</div>
                    </td>
                    <td className="text-center py-4 px-4">
            ...
            <div className="bg-white rounded-xl shadow-lg border p-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-amber-50 rounded-lg">
                  <div className="text-2xl font-bold text-amber-600 mb-1">15x</div>
                  <div className="text-sm text-gray-600">Traffic gap vs. Calumet Bourbon</div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border p-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-green-50 rounded-lg">
                  <div className="text-lg font-bold text-green-600 mb-1">Celebrity Partnership</div>
                  <div className="text-sm text-gray-600">Dierks Bentley association</div>
                </div>
                <p className="text-gray-700 text-sm">
          ...
          {/* Growth Projection */}
          <div className="mt-8 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-8 border-l-4 border-amber-500">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Row 94's Growth Trajectory</h3>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-gray-400 mb-2">557</div>
                <div className="text-sm text-gray-500 mb-1">Current Traffic</div>
                <div className="text-xs text-red-500">Baseline</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-amber-600 mb-2">1,200</div>
                <div className="text-sm text-gray-600 mb-1">6-Month Target</div>
                <div className="text-xs text-amber-500">+115% growth</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-600 mb-2">2,100</div>
                <div className="text-sm text-gray-600 mb-1">12-Month Goal</div>
                <div className="text-xs text-orange-500">+277% growth</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">4,000+</div>
                <div className="text-sm text-gray-600 mb-1">18-Month Vision</div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-8">
            <div className="text-center mb-8">
              <div className="text-4xl font-bold text-grey-600 mb-2">12 Weeks</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            {showBackToTop && (
              <Button
                onClick={scrollToTop}
                className="mb-6 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-bold"
                size="sm"
              >
